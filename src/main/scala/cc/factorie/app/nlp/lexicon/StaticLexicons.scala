...
class StaticLexicons()(implicit lp:LexiconsProvider) {
  ...
  object spanish {
    ...
    object MajorLocationCityOsmp extends major.LocationCityOsmp()(lp.provide[major.LocationCityOsmp])
    object MajorLocationCityWiki extends major.LocationCityWiki()(lp.provide[major.LocationCityWiki])
    object MajorLocationCitytownFree extends major.LocationCitytownFree()(lp.provide[major.LocationCitytownFree])
    object MajorLocationCountryWiki extends major.LocationCountryWiki()(lp.provide[major.LocationCountryWiki])
    ...
    object MajorLocationStateWiki extends major.LocationStateWiki()(lp.provide[major.LocationStateWiki])
    object MajorLocationUndefinedWiki extends major.LocationUndefinedWiki()(lp.provide[major.LocationUndefinedWiki])
    ...
    object MinorLocationCityOsmp extends minor.LocationCityOsmp()(lp.provide[minor.LocationCityOsmp])
    object MinorLocationCityWiki extends minor.LocationCityWiki()(lp.provide[minor.LocationCityWiki])
    object MinorLocationCitytownFree extends minor.LocationCitytownFree()(lp.provide[minor.LocationCitytownFree])
    object MinorLocationCountryWiki extends minor.LocationCountryWiki()(lp.provide[minor.LocationCountryWiki])
    ...
    object MinorLocationStateWiki extends minor.LocationStateWiki()(lp.provide[minor.LocationStateWiki])
    object MinorLocationUndefinedWiki extends minor.LocationUndefinedWiki()(lp.provide[minor.LocationUndefinedWiki])
