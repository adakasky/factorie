...
class StaticLexicons()(implicit lp:LexiconsProvider) {
  ...
  object spanish {
    ...
    object MajorPeopleFirstIesl extends major.PeopleFirstIesl()(lp.provide[major.PeopleFirstIesl])
    object MajorPeopleHonorificIesl extends major.PeopleHonorificIesl()(lp.provide[major.PeopleHonorificIesl])
    object MajorPeopleIesl extends major.PeopleIesl()(lp.provide[major.PeopleIesl])
    object MajorPeopleLastIesl extends major.PeopleLastIesl()(lp.provide[major.PeopleLastIesl])
    object MajorPeopleRedirectWiki extends major.PeopleRedirectWiki()(lp.provide[major.PeopleRedirectWiki])
    object MajorPeopleWiki extends major.PeopleWiki()(lp.provide[major.PeopleWiki])
    ...
    object MinorPeopleFirstIesl extends minor.PeopleFirstIesl()(lp.provide[minor.PeopleFirstIesl])
    object MinorPeopleHonorificIesl extends minor.PeopleHonorificIesl()(lp.provide[minor.PeopleHonorificIesl])
    object MinorPeopleIesl extends minor.PeopleIesl()(lp.provide[minor.PeopleIesl])
    object MinorPeopleLastIesl extends minor.PeopleLastIesl()(lp.provide[minor.PeopleLastIesl])
    object MinorPeopleRedirectWiki extends minor.PeopleRedirectWiki()(lp.provide[minor.PeopleRedirectWiki])
    object MinorPeopleWiki extends minor.PeopleWiki()(lp.provide[minor.PeopleWiki])
